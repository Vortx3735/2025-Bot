...
public class Robot extends LoggedRobot {
  ...
  public void disabledPeriodic() {
    CommandScheduler.getInstance().schedule(PositionPIDCommand.generateCommand(robotContainer.drivetrain, robotContainer.reefCamera).withName("readFromCamera"));
  ...
  public void simulationPeriodic() {
    ...
    // Logger.recordOutput("ZeroedElevator", new Pose3d());
